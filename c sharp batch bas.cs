...
namespace titanicBES
{
    ...
    class Program
    {
        ...
        {
            const string OutputFileLocation = "c:\\ml\\myresults.csv"; // Replace this with the location you would like to use for your output file
        ...
        static async Task InvokeBatchExecutionService()
        {
            ...
            const string BaseUrl = "https://ussouthcentral.services.azureml.net/workspaces/ede12cb3aaf24c7e826493f4e309f1e1/services/ad3b577804c443d08f0f30b6c8028411/jobs";

            const string StorageAccountName = "loy2018sa"; // Replace this with your Azure Storage Account name
            const string StorageAccountKey = "4oKF2tzfkDk/H6eYzHa8YwpV/pNB9oVprOpc3PNIRrL/EduRP6/o2css1tX4p47ateS8AfT2DUetjgLv4Tr3hg=="; // Replace this with your Azure Storage Key
            const string StorageContainerName = "blob1"; // Replace this with your Azure Storage Container name
            string storageConnectionString = string.Format("DefaultEndpointsProtocol=https;AccountName={0};AccountKey={1}", StorageAccountName, StorageAccountKey);
            const string apiKey = "IJh2PfzFAh5Q4Hsj/vod6PjgOlTBWeng2f2C+89Sv/1t1Vr7KaDZfequmXPzhAZNs9KjkaklAcSuRvTLy47/yw=="; // Replace this with the API key for the web service
            ...
            UploadFileToBlob("c:\\ml\\input1data.csv" /*Replace this with the location of your input file*/,
