...
namespace test3
{
    ...
    class Program
    {
        const string OutputFileLocation = @"c:\temp\myresults.csv"; // Replace this with the location you would like to use for your output file
        const string localFile = @"c:\temp\data.csv";
        const string BaseUrl = "xx";    // replace with your base url

        const string StorageAccountName = "xx"; // Replace this with your Azure Storage Account name
        const string StorageAccountKey = "xx"; // Replace this with your Azure Storage Key
        const string StorageContainerName = "blob1"; // Replace this with your Azure Storage Container name
        const string apiKey = "xx"; // Replace this with the API key for the web service
